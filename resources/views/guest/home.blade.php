...
<body class="text-gray-200 overflow-x-hidden">
    ...
    <nav class="fixed top-0 w-full bg-slate-900/90 backdrop-blur-lg border-b border-slate-700 z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-6 text-sm">
                ...
                @endguest
                @auth
                    <a href="{{ route('home') }}" class="px-4 py-2 bg-green-500 rounded-xl hover:bg-green-600 transition">
                        Dashboard
                    </a>
    ...
    <section id="tentang" class="py-24 bg-slate-900">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h3 class="text-3xl font-extrabold text-white mb-4">Tentang UKM Futsal PCR</h3>
            <p class="text-gray-400 max-w-2xl mx-auto">
                UKM Futsal Politeknik Caltex Riau merupakan wadah pengembangan minat dan bakat mahasiswa
                di bidang olahraga futsal secara profesional, kompetitif, dan berprestasi.
            </p>
        </div>
    </section>
    <!-- STATISTIK -->
    ...
    <section id="fitur" class="py-24">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-slate-800 rounded-3xl p-8 border border-slate-700 hover:border-green-500 transition"
                    data-aos="zoom-in">
    ...
    <!-- KEGIATAN -->
    <section id="kegiatan" class="py-24 bg-slate-900">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h3 class="text-3xl font-extrabold text-white mb-4">Kegiatan Kami</h3>
            <p class="text-gray-400 mb-12">
                Aktivitas rutin dan kompetisi yang diikuti UKM Futsal PCR
            </p>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-slate-800 p-6 rounded-2xl border border-slate-700">
                    <h4 class="text-xl font-bold mb-2">Latihan Rutin</h4>
                    <p class="text-gray-400">Latihan mingguan bersama pelatih profesional.</p>
                </div>

                <div class="bg-slate-800 p-6 rounded-2xl border border-slate-700">
                    <h4 class="text-xl font-bold mb-2">Turnamen</h4>
                    <p class="text-gray-400">Mengikuti berbagai kompetisi antar kampus.</p>
                </div>

                <div class="bg-slate-800 p-6 rounded-2xl border border-slate-700">
                    <h4 class="text-xl font-bold mb-2">Sparring</h4>
                    <p class="text-gray-400">Uji tanding dengan tim futsal lain.</p>
                </div>
            </div>
        </div>
    </section>
